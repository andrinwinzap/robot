...
theta_1, theta_2, theta_3, theta_4, theta_5, theta_6 = symbols(
...
def compute_symbolic_fk():
    ...
    J = Matrix.vstack(Matrix.hstack(*J_v), Matrix.hstack(*J_w))
...
R_03_func = lambdify(
    (theta_1, theta_2, theta_3), symbolic_fk["T_03_symbolic"][:3, :3], modules="numpy"
)
